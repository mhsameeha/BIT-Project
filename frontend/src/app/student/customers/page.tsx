...
import { CustomersFilters } from '@/components/main/customer/customers-filters';
import { CustomersTable } from '@/components/main/customer/customers-table';
import type { Customer } from '@/components/main/customer/customers-table';
