...
export const SESSION_REQUESTS: SessionRequest[] = [
  ...
  // Additional completed sessions for income calculation
  {
    sessionId: 'SESSION-007',
    studentId: 'STUDENT-007',
    tutorId: 'TUTOR-001',
    learnerName: 'Kasuni Perera',
    sessionName: 'Python Fundamentals - Variables & Functions',
    sessionDate: dayjs().subtract(5, 'day').format('YYYY-MM-DD'),
    sessionTime: '10:00 AM - 12:00 PM',
    duration: 2,
    totalCost: 7000,
    currency: 'LKR',
    status: SessionStatus.Completed,
    createdDate: dayjs().subtract(1, 'week').toDate(),
    updatedDate: dayjs().subtract(5, 'day').toDate(),
    timeSlots: ['10:00 AM', '11:00 AM'],
    studentAvatar: '/assets/avatar-1.png',
    studentEmail: 'kasuni.perera@email.com',
  ...
  },
  {
    ...
    tutorId: 'TUTOR-001',
    learnerName: 'Dinesh Silva',
    sessionName: 'Python Data Analysis',
    sessionDate: dayjs().subtract(10, 'day').format('YYYY-MM-DD'),
    sessionTime: '02:00 PM - 04:00 PM',
    duration: 2,
    totalCost: 7000,
    currency: 'LKR',
    status: SessionStatus.Completed,
    createdDate: dayjs().subtract(2, 'week').toDate(),
    updatedDate: dayjs().subtract(10, 'day').toDate(),
    timeSlots: ['02:00 PM', '03:00 PM'],
    studentAvatar: '/assets/avatar-2.png',
    studentEmail: 'dinesh.silva@email.com',
  ...
  },
  {
    ...
    tutorId: 'TUTOR-001',
    learnerName: 'Achini Fernando',
    sessionName: 'Web Development Basics',
    sessionDate: dayjs().subtract(15, 'day').format('YYYY-MM-DD'),
    sessionTime: '09:00 AM - 11:00 AM',
    duration: 2,
    totalCost: 7000,
    currency: 'LKR',
    status: SessionStatus.Completed,
    createdDate: dayjs().subtract(3, 'week').toDate(),
    updatedDate: dayjs().subtract(15, 'day').toDate(),
    timeSlots: ['09:00 AM', '10:00 AM'],
    studentAvatar: '/assets/avatar-3.png',
    studentEmail: 'achini.fernando@email.com',
