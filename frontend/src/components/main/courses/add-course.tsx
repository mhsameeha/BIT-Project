...
import { getAllCategories } from '@/Services/courses';
...
const schema = zod.object({
  ...
  price: zod
    .number({ invalid_type_error: 'Price must be greater than 0' })
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FormControl error={Boolean(errors.courseDescription)} fullWidth>
                    ...
                    <OutlinedInput {...field} label="Course Description" multiline rows={4} />
                  ...
                  <FormControl error={Boolean(errors.courseCategory)} fullWidth>
                    ...
                    <Select {...field} label="Course Category" onChange={handleChange}>
                      {categoryList.map((list: Category) => (
                        <MenuItem key={list.categoryId}>{list.categoryName}</MenuItem>
                      ))}
                    </Select>
